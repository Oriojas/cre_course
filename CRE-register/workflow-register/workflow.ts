...
export function onEn5Munutos(
  runtime: Runtime<Config>,
  payload: CronPayload,
): string {
  if (!payload.scheduledExecutionTime)
    throw new Error("Missing scheduledExecutionTime");
  runtime.log("En 5 munutos triggered at " + payload.scheduledExecutionTime);
  ...
  const reportPayload = encodeAbiParameters(
    ...
    ["Oscar, Colombia"], // TODO: fill actual report data
  );
  ...
  runtime.log(
    `RegisterUsingCRE.sol.RegisterSet tx: ${bytesToHex(writeResult.txHash || new Uint8Array(32))}`,
  );
